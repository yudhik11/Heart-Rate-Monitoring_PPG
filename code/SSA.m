function [yrecon, locs MA] = SSA(x1, Fs, prevBPM, s)
    ...
    %   locs MA = locations of the maximum peaks of the acceleration data
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [deleteComponents, locs MA] = RoC(acc, y, Fs, prevBPM);
    yrecon = zeros(1,N);
